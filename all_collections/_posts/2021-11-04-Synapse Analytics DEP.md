...
- In the public cloud business, data exfiltration usually stands for the second scenario: a malicious insider, with legitimate access to sensitive data, is exfiltrating it to locations outside of the organization.
...
Historical ways to address the data leakage risk for Azure ressources are:
- Azure managed services VNet injection
- Using Azure Firewall in a hub & spoke architecture
- Azure Private Endpoints
- Azure Service Endpoint & Service Endpoint Policies   
...
It is possible to connect to other data sources from your Managed Synapse workspace through managed private endpoints deployed in the managed Vnet.
